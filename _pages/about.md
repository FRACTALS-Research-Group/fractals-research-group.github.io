...
<div class="quote-container" style="margin: 50px 0; text-align: center; position: relative; padding: 40px 20px; border-top: 1px solid var(--global-divider-color); border-bottom: 1px solid var(--global-divider-color);">
    <div style="position: absolute; top: -20px; left: 50%; transform: translateX(-50%); background-color: var(--global-bg-color); padding: 0 15px;">
        <i class="fas fa-quote-left" style="font-size: 2rem; color: var(--global-theme-color); opacity: 0.4;"></i>
    </div>
    ...
    <div style="position: absolute; bottom: -20px; left: 50%; transform: translateX(-50%); background-color: var(--global-bg-color); padding: 0 15px;">
        <i class="fas fa-quote-right" style="font-size: 2rem; color: var(--global-theme-color); opacity: 0.4;"></i>
    </div>
</div>
...
<section class="pillars-section" style="margin-bottom: 60px;">
    ...
    <div class="row">
        ...
        <div class="col-sm-6 mb-5">
            ...
            <p style="font-size: 0.95rem; opacity: 0.85;">Mastering the non-linear dynamics governing life, from cellular networks to systemic health interactions.</p>
        </div>
        <div class="col-sm-6 mb-5">
            <h5 style="font-weight: 800; display: flex; align-items: center; gap: 10px;">
                <i class="fas fa-hospital-user" style="color: var(--global-theme-color);"></i> Medicine
            </h5>
            <p style="font-size: 0.95rem; opacity: 0.85;">Developing advanced clinical diagnostics and precision healthcare models to translate data into life-saving outcomes.</p>
        </div>
        <div class="col-sm-6 mb-5">
            <h5 style="font-weight: 800; display: flex; align-items: center; gap: 10px;">
        ...
        <div class="col-sm-6 mb-5">
            <h5 style="font-weight: 800; display: flex; align-items: center; gap: 10px;">
                <i class="fas fa-microchip" style="color: var(--global-theme-color);"></i> High Performance Computing (HPC)
            </h5>
            <p style="font-size: 0.95rem; opacity: 0.85;">Leveraging massive computational power to push the boundaries of data processing and simulation at scale.</p>
        </div>
        <div class="col-sm-6 mb-5">
            <h5 style="font-weight: 800; display: flex; align-items: center; gap: 10px;">
