...
inline: false
permalink: /news/AIMedSurgery2026
categories: [news]
---
...
<div class="event-hero-container" style="background: var(--global-code-bg-color); border-radius: 20px; padding: 40px; margin-bottom: 40px; border: 1px solid var(--global-divider-color); box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
    <div class="row align-items-center">
        <div class="col-lg-7">
            <span class="badge mb-3 font-weight-bold" style="background-color: var(--global-theme-color); color: var(--global-bg-color); padding: 6px 16px; border-radius: 50px; font-size: 0.8rem; letter-spacing: 1px; text-transform: uppercase;">
                Università Ca’ Foscari Venezia e Fondazione Ospedale Villa Salus
            </span>
            <h1 style="font-weight: 900; color: var(--global-text-color); line-height: 1.15; margin-bottom: 20px; font-size: 2.5rem;">
                Il ruolo dell'Intelligenza Artificiale nelle decisioni cliniche in Medicina e Chirurgia
            </h1>
            <p class="lead" style="font-size: 1.2rem; font-weight: 300; color: var(--global-text-color); opacity: 0.85; margin-bottom: 30px;">
                Un punto di incontro tra chirurghi, clinici, esperti di informatica e giuristi per tracciare il futuro della sanità digitale, tra opportunità rivoluzionarie e sfide etico-legali.
            </p>
            
            <div class="row no-gutters mb-4" style="gap: 15px;">
                ...
                <div class="col-sm shadow-xs p-3 text-center" style="background: var(--global-card-bg-color); border: 1px solid var(--global-divider-color); border-radius: 12px; min-width: 140px;">
                    ...
                    <div class="small font-weight-bold" style="color: var(--global-text-color);">Auditorium Mainardi</div>
                    <div style="color: var(--global-text-color); opacity: 0.6; font-size: 0.75rem;">Campus Scientifico, Mestre</div>
                </div>
                <div class="col-sm shadow-xs p-3 text-center" style="background: var(--global-card-bg-color); border: 1px solid var(--global-divider-color); border-radius: 12px; min-width: 140px;">
            ...
            <div class="d-flex flex-wrap align-items-center" style="gap: 15px;">
                <a href="/register-AIMedSurgery2026/" target="_blank" class="btn btn-lg z-depth-1 action-btn-register" 
        ...
        <div class="col-lg-5 mt-4 mt-lg-0">
            <div class="img-wrapper position-relative" style="z-index: 1;">
                <div style="position: absolute; top: 15px; left: 15px; right: -15px; bottom: -15px; background: var(--global-theme-color); border-radius: 16px; opacity: 0.15; z-index: -1;"></div>
                <img src="{{ '/assets/img/img18sett.png' | relative_url }}" alt="AI in Medicine and Surgery" class="img-fluid rounded shadow-lg w-100" style="object-fit: cover; border: 4px solid var(--global-card-bg-color);">
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-8 mb-5">
        <h3 class="mb-4 font-weight-bold" style="letter-spacing: -0.5px; color: var(--global-text-color);">
            <i class="far fa-clock mr-2" style="color: var(--global-theme-color);"></i> Programma Scientifico
        </h3>

        <div class="fancy-timeline" style="position: relative; padding-left: 30px; border-left: 3px solid var(--global-divider-color); margin-left: 15px;">
            ...
            <div class="timeline-item mb-4" style="position: relative;">
                ...
                <div class="card p-4 shadow-sm border-0" style="border-left: 5px solid var(--global-theme-color) !important; background: var(--global-card-bg-color);">
                    ...
                    <p class="small font-italic mb-3" style="color: var(--global-text-color); opacity: 0.7;">Esperienze personali tra opportunità e sfide</p>
                    <div class="p-3 rounded small" style="background: var(--global-code-bg-color); color: var(--global-text-color);">
                        <div class="mb-2"><strong>Moderatore:</strong> Franco Cozzi</div>
                        <div><strong>Relatori:</strong> Giulio Bergamasco, Emanuela Blundetto.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="timeline-item mb-4" style="position: relative;">
                ...
                <div class="card p-4 shadow-xs border-0 backend-card-glow">
                    ...
                    <div class="p-3 rounded small" style="background: var(--global-code-bg-color); color: var(--global-text-color);">
                        ...
                        <div><strong>Relatore:</strong> Claudio Cordiano</div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-4">
        <div class="sticky-top" style="top: 40px;">
            ...
            <div class="card p-4 border-0 shadow-sm mb-4" style="background: var(--global-card-bg-color); border-radius: 16px;">
                <h5 class="font-weight-bold mb-4 pb-2" style="color: var(--global-text-color); border-bottom: 2px solid var(--global-divider-color);">
                    <i class="fas fa-users-cog mr-2" style="color: var(--global-theme-color);"></i> Organizing Committee
                </h5>
                
                <div class="organizer-node mb-3 d-flex align-items-start">
                    <div class="mini-avatar"><i class="fas fa-user"></i></div>
                    <div>
                        <div class="font-weight-bold small" style="color: var(--global-text-color);">Marco Salvatore Nobile</div>
                        <div style="color: var(--global-text-color); opacity: 0.6; font-size: 0.75rem;">Università Ca’ Foscari Venezia</div>
                    </div>
                </div>
                ...
                <div class="organizer-node mb-3 d-flex align-items-start">
                    <div class="mini-avatar"><i class="fas fa-user"></i></div>
                    <div>
                        <div class="font-weight-bold small" style="color: var(--global-text-color);">Francesca Dal Mas</div>
                        <div style="color: var(--global-text-color); opacity: 0.6; font-size: 0.75rem;">Università Ca’ Foscari Venezia</div>
                    </div>
                </div>
                ...
                <div class="organizer-node mb-3 d-flex align-items-start">
                    <div class="mini-avatar"><i class="fas fa-user"></i></div>
                    <div>
                        <div class="font-weight-bold small" style="color: var(--global-text-color);">Matteo Grazioso</div>
                        <div style="color: var(--global-text-color); opacity: 0.6; font-size: 0.75rem;">Università Ca’ Foscari Venezia</div>
                    </div>
                </div>
                
                <div class="organizer-node mb-3 d-flex align-items-start">
                    <div class="mini-avatar" style="border-color: var(--global-divider-color); opacity: 0.8;"><i class="fas fa-hospital-user"></i></div>
                    <div>
                        <div class="font-weight-bold small" style="color: var(--global-text-color);">Angelo Gabriele Chiappetta</div>
                        <div style="color: var(--global-text-color); opacity: 0.6; font-size: 0.75rem;">Fondazione Ospedale Villa Salus</div>
                    </div>
                </div>
                
                <div class="organizer-node d-flex align-items-start">
                    <div class="mini-avatar" style="border-color: var(--global-divider-color); opacity: 0.8;"><i class="fas fa-hospital-user"></i></div>
                    <div>
                        <div class="font-weight-bold small" style="color: var(--global-text-color);">Franco Cozzi</div>
                        <div style="color: var(--global-text-color); opacity: 0.6; font-size: 0.75rem;">Fondazione Ospedale Villa Salus</div>
                    </div>
                </div>
            </div>

            <div class="card p-4 border-0 shadow-sm text-center" style="background: var(--global-card-bg-color); border-radius: 16px;">
                <i class="fas fa-university mb-3" style="font-size: 2.5rem; color: var(--global-text-color); opacity: 0.4;"></i>
                <h6 class="font-weight-bold mb-1" style="color: var(--global-text-color);">Sede dell'Evento</h6>
                <p class="small mb-0" style="color: var(--global-text-color); opacity: 0.8;">
                    Università Ca’ Foscari Venezia<br>
                    <strong>Campus Scientifico — Auditorium Mainardi</strong><br>
                    Via Torino 155, Venezia Mestre (VE)
                </p>
            </div>
...
<style>
    ...
    .timeline-dot {
        position: absolute; left: -37px; top: 22px; width: 12px; height: 12px;
        border-radius: 50%; background: var(--global-card-bg-color);
        border: 3px solid var(--global-divider-color); z-index: 2;
    }
    .timeline-dot-active {
        position: absolute; left: -39px; top: 20px; width: 16px; height: 16px;
        border-radius: 50%; background: var(--global-theme-color);
        border: 4px solid var(--global-card-bg-color); z-index: 2;
    }
    .timeline-dot-break {
        position: absolute; left: -43px; top: 4px; width: 24px; height: 24px;
        border-radius: 50%; background: var(--global-code-bg-color);
        border: 1px solid var(--global-divider-color); z-index: 2;
        display: flex; align-items: center; justify-content: center;
        font-size: 0.65rem; color: var(--global-text-color);
    }
    ...
    @media (max-width: 768px) {
        .event-hero-container { padding: 20px; }
        .fancy-timeline { margin-left: 5px; }
    }
</style>